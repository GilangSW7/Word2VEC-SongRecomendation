...
class word2vec():
    ...
    def vec_sim(self, vec, top_n):
        ...
        words_sorted = sorted(word_sim.items(), key=lambda woord: woord[1], reverse=True)
...
settings['learning_rate'] = 0.025  # learning rate
...
corpus = [['the', 'quick', 'brown', 'fox', 'jumped', 'over', 'the', 'lazy', 'dog'],["ayam","ayam"]]
#corpus = [getLyrick.getcorpus()]

# INITIALIZE W2V MODEL
w2v = word2vec()

# generate training data
training_data = w2v.generate_training_data(settings, eng_Korpus_prepro)
#print(training_data)
# train word2vec model
w2v=w2v.train(training_data)

with open('eng_W2V_NsteamT.csv', 'w', newline='') as my_csv:
    csvWriter = csv.writer(my_csv, delimiter=',')
    csvWriter.writerows(w2v)
# with open('eng_Repre_Nsteam.csv', 'w', newline='') as my_csv:
#     csvWriter = csv.writer(my_csv)
#     csvWriter.writerow(w2v.)

#print (w2v.word_sim("ayam",2))
